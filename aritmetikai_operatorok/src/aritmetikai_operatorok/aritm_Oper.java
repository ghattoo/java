...
public class aritm_Oper {
	...
	public static void main(String[] args) {
		...
		float szam6 = 7f / szam2; //osztas decimális számhoz float
		int szam6b = 7 % 3;
		...
		System.out.println("Modulo: " + szam7 + " a maradék osztas utan");
		...
		//precedencia; és aritmetika
		System.out.println("Precedencia: " + szam40);
		
		// Összehasonlito operatorok (== > < != >= <= )
		szam2 = 3; //ez hozzárendelés, nem összetévesztendõ a == el!!!
		System.out.println();
